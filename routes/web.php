...
Route::get('/customer/orders/{order}', [CartController::class, 'show'])->name('customer.orders.show');
...
Route::middleware(['auth', AuthAdmin::class])->group(function(){
    ...
    Route::delete('/admin/category/delete/{id}/delete',[AdminController::class,'category_delete'])->name('admin.category.delete');
    ...
    Route::delete('/admin/product/delete/{id}/delete',[AdminController::class,'product_delete'])->name('admin.product.delete');
    ...
    Route::delete('/admin/coupon/delete/{id}/delete',[AdminController::class,'coupon_delete'])->name('admin.coupon.delete');
