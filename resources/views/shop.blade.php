        ...
        <div class="accordion" id="price-filters">
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              data-slider-min="{{ $global_min_price }}"
              data-slider-max="{{ $global_max_price }}"
              ...
              <div class="price-range__info d-flex align-items-center mt-2">
                ...
                <div>
                  ...
                  <span class="price-range__max">Rp 5.000.000</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="shop-list flex-grow-1">
            ...
            <div class="swiper-slide">
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  style="background-color: #a1e2b0;">
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Tanaman <br /><strong>INDOOR</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Menyediakan berbagai tanaman indoor yang cantik dan menarik. Cocok untuk menjadi hiasan didalam rumah!</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/banner.jpg" width="630" height="450"
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Tanaman <br /><strong>OUTDOOR</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Tidak hanya indoor, disini juga menyediakan tanaman outdoor yang tidak kalah cantiknya dengan indoor!</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/banner2.jpg" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Tanaman<br /><strong>OBAT</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Selain indoor dan outdoor, disini juga menyediakan berbagai macam tanaman obat atau yang biasa kita sebut tanaman Toga!</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/kumiskucing.jpg" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size" style="margin-right: 20px"
  ...
  <script>
    $(function(){
      ...
      $("input[name='brands']").on("change",function(){
        ...
        console.log("Filter brand terpilih: " + brands); // DEBUG
